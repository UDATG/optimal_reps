...
(
            ...
            Filtration: PartialOrd + Clone,
    {
        ...
        // Set types(integer or real) to the variables
...
fn main() {    
 ...
 println!("length : {:?}",simplex_bar.len());
...
//     // read file
//     let mut f = BufReader::new(File::open("/Users/summerResearch2020/Downloads/optimal_reps/senate104_edge_list.txt_0.68902_distmat.txt").unwrap());
//     let mut s = String::new();
